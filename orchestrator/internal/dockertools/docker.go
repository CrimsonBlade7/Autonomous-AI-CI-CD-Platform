...
func RunContainer(ctx context.Context, cm ContainerManager, tag string, command []string) (id string, outReader io.ReadCloser, errReader io.ReadCloser, err error) {
