...
def _build_test_stub(parsed: ParsedError, fixture_slug: str, pr_description: str = "") -> str:
    ...
    intent_note = json.dumps(pr_description.strip() or "No PR description supplied.")
    return textwrap.dedent(f"""\
        ...
        # PR intent is retained here so reviewers can align source-level fixes with the request.
        PR_INTENT = {intent_note}
